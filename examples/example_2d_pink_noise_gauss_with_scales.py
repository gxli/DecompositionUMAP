...
np.save('pink_noise_gauss_data.npy', data)
np.save('pink_noise_gauss_signal.npy', signal)
np.save('pink_noise_gauss_anomaly.npy', anomaly)
np.save('pink_noise_gauss_umap_x.npy', datax)
np.save('pink_noise_gauss_umap_y.npy', datay)
