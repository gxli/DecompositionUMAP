...
from .multiscale_decomposition import (cdd_decomposition, emd_decomposition, wavelet_decomposition)
...
class DecompositionUMAP:
    ...
    Args:
        ...
        decomposition_method (str, optional): The name of a built-in decomposition
            method (e.g., 'cdd', 'emd' and 'wavelet') to use if `original_data` is provided
            ...
            if base_decomp_func is None:
                ...
                def build_func(d):
                    if decomposition_method == 'cdd':
                        ...
                        res = wavelet_decomposition(d, max_n=decomposition_max_n)
...
def decompose_and_embed(data=None, datasets=None, data_multivariate=None, decomposition=None,
    ...
    Args:
        ...
        decomposition_method (str, optional): The name of the decomposition method (e.g., 'cdd', 'emd', 'wavelet').
